...
function resizeDiv() {
			...
			jQuery("#e-7,#e-7,#e-9").css({"height": vresdiv + "px"});
							...
							<div class="row-fluid">
								<div class="span8" id="left_mailDiv">
									<div class="tabbedwidget tab-primary" id="main_div" > <!--height:500px;overflow:scroll;-->
								            ...
								            <div id="e-7" class="ui-tabs-panel ui-widget-content ui-corner-bottom" style="height: 693px; overflow-y: hidden;"> <!--height:auto;-->
